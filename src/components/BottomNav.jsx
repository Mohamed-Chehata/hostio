...
export function BottomNav({ active, onNavigate }) {
  return (
    <nav className="fixed bottom-0 left-1/2 z-30 flex w-full max-w-[390px] -translate-x-1/2 items-center justify-around border-t border-border bg-nav/95 px-2 pb-[max(10px,env(safe-area-inset-bottom))] pt-3 backdrop-blur">
