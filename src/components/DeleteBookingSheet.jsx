  ...
  return (
    <BottomSheet title="" onClose={onCancel}>
      <div className="text-center">
        ...
        <button onClick={onConfirm} className="mt-6 w-full rounded-2xl bg-red-500 px-4 py-3 text-sm font-extrabold text-white transition active:scale-[0.98]">Delete</button>
